...
public class AdminReviewView {
    ...
    ;
    private Button updateButton,backButton,denyButton;
    ...
    public void components() {
        ...
        updateButton = new Button("Accept");
...
//everything aligned with t stands for text
    ...
    public void addComponents() {
        ...
        pane.getChildren().addAll(fName,lName,email,phone,dob,classification,major,
                fnameT,lnameT,emailT,phoneT,dobT,classificationT,majorT, personalInfoText, updateButton,denyButton,
