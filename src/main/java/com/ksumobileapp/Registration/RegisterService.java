...
public void databaseConnection(RegisterModel registerModel) throws SQLException {
    ...
    String sql = "INSERT INTO users(firstName,lastName,email,password,phone,dob,classification,major) VALUES(?,?,?,?,?,?,?,?)";
    ...
    try (Connection connection = DriverManager.getConnection(url)) {
        ...
        PreparedStatement pstmt = connection.prepareStatement(sql);
        {
            ...
            pstmt.setString(4,registerModel.getPassword());
            pstmt.setString(5,registerModel.getPhone());
            pstmt.setString(6,registerModel.getDob());
            pstmt.setString(7,registerModel.getClassification());
            pstmt.setString(8,registerModel.getMajor());
            pstmt.executeUpdate();
